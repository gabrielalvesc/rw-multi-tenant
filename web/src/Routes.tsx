...
const Routes = () => {
  return (
    <Router useAuth={useAuth}>
      ...
      <PrivateSet wrap={DashboardLayout} unauthenticated="login" roles={[ROLES_NAMES.ADMIN]} whileLoadingAuth={ScreenLoading}>
        <Route path="/" page={HomePage} name="home" />
      </PrivateSet>
      <PrivateSet wrap={CitizenLayout} unauthenticated="citizenLogin" roles={[ROLES_NAMES.PUBLIC_NAME, ROLES_NAMES.CITIZEN]} whileLoadingAuth={ScreenLoading}>
        <Route path="/cidadao" page={HomePage} name="citizenHome" />
      </PrivateSet>
      <PrivateSet wrap={PublicAgentLayout} unauthenticated="publicAgentLogin" roles={[ROLES_NAMES.PUBLIC_NAME, ROLES_NAMES.ADMIN]} whileLoadingAuth={ScreenLoading}>
